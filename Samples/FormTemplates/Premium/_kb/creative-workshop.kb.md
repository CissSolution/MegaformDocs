# Creative Workshop Registration - MegaForm AI Design Contract

Source mock route: /forms/creative-workshop
Template slug: creative-workshop
...
- Any AI edit must leave `settings.templateGuideSlug` pointing to `tpl-creative-workshop`.
