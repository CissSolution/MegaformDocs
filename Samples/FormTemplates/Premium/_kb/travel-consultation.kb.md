# Travel Consultation - MegaForm AI Design Contract

Source mock route: /forms/travel-consultation
Template slug: travel-consultation
...
- Any AI edit must leave `settings.templateGuideSlug` pointing to `tpl-travel-consultation`.
