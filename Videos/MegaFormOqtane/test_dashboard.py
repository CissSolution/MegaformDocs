...
async def main():
    ...
    async with async_playwright() as p:
        ...
        # Click MegaForm menu
        await page.click('text=MegaForm', timeout=5000)
        await page.wait_for_timeout(500)
        await page.click('text=Form Dashboard', timeout=5000)
        await page.wait_for_timeout(4000)
        print("URL:", page.url)
        print("Title:", await page.title())
        await page.screenshot(path='recordings/dashboard.png', full_page=False)
