...
> [!NOTE]
> The gallery is served online and grows without an upgrade: **68 designs** as of 9 August 2026,
> up from 48 in July. Your install reads the current list every time it opens, so a design
> published after you installed MegaForm still appears.
