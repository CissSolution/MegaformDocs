...
Generated: 2026-07-17T06:12:00.192Z · Files: 17

| File | theme (settings?) | CSS src | CSS KB | hard main | hard tokendef | fonts | prefixes | manifest | issues |
|---|---|---|---:|---:|---:|---:|---|---|---|
| Discovery-programme.json | bulgaria-discovery-premium | settings.customCss | 19.3 | 69 | 15 | 9 | bg mf | v2/locked | top-level keys DROPPED by catalog (dormant): themeSelector |
| Journey.json | americana-journey-premium | settings.customCss | 51.7 | 66 | 2 | 42 | am bs mf | v2/locked | top-level keys DROPPED by catalog (dormant): themeSelector |
| classic-registration.json | system (top only→DROPPED) | settings.customCss | 39.7 | 121 | 17 | 3 | mf | v2/hybrid | top-level keys DROPPED by catalog (dormant): theme, customScripts |
| contact-map-left-corporate.json | pure-grid-premium | settings.customCss | 11.7 | 6 | 13 | 2 | card mf muted primary | v2/tokenized | clean |
| contact-map-left-minimal.json | pure-grid-premium | settings.customCss | 18.3 | 12 | 13 | 1 | card mf muted primary | v2/tokenized | clean |
| contact-map-right-modern.json | pure-grid-premium | settings.customCss | 18.3 | 12 | 13 | 1 | card mf muted primary | v2/tokenized | clean |
| down-under.json | down-under-reef-premium | settings.customCss | 21.9 | 20 | 2 | 8 | au mf | v2/hybrid | clean |
| event-registration-rsvp.json | system (top only→DROPPED) | settings.customCss | 63.5 | 77 | 12 | 0 | mf | v2/tokenized | top-level keys DROPPED by catalog (dormant): theme |
| festa-italiana.json | festa-italiana-premium | settings.customCss | 26.4 | 49 | 16 | 12 | card fi mf muted primary | v2/locked | clean |
| megaform-pure-grid-template.json | pure-grid-premium | settings.customCss | 5.4 | 12 | 12 | 0 | mfp | v2/hybrid | clean |
| member-login.json | custom | settings.customCss | 4.4 | 19 | 0 | 0 | mf mfl | v2/hybrid | clean |
| outback-station-stay-booking.json | system | settings.customCss | 36.1 | 57 | 5 | 0 | mf | v2/hybrid | clean |
| project-intake-onboarding.json | system (top only→DROPPED) | settings.customCss | 39.6 | 30 | 5 | 0 | mf | v2/tokenized | top-level keys DROPPED by catalog (dormant): theme, customScripts |
| tabbed-account-setup.json | tabbed-account-setup | settings.customCss | 21.5 | 46 | 12 | 1 | tab | v2/hybrid | clean |
| vendor-application-fl.json | pure-grid-premium | settings.customCss | 6.6 | 14 | 10 | 0 | fl | v2/hybrid | clean |
| wellness-patient-intake.json | system (top only→DROPPED) | settings.customCss | 65.4 | 58 | 43 | 1 | mf mfp | v2/tokenized | top-level keys DROPPED by catalog (dormant): theme |
| youth-application.json | euro-youth-premium | settings.customCss | 31.8 | 121 | 6 | 6 | aur card mf muted nola primary | v2/hybrid | clean |
