...
namespace MegaForm.Web.Controllers
{
    ...
    public class RazorWidgetController : ControllerBase
    {
        ...
        public IActionResult Source([FromQuery] string name)
        {
            ...
            // Embedded resource naming: MegaForm.Web.RazorSource.<Name>.razor
            var resourceName = $"MegaForm.Web.RazorSource.{name}.razor";
        ...
        public IActionResult Compile([FromBody] CompileRequest req)
        {
            ...
            var svc = _services.GetService(typeof(RazorCompilationService)) as RazorCompilationService;
