---
{
  ...
  "customCssSha256": "05e2702eb24a489ec89e02e961c64850a72cb21c3583534102d74b3759805e82",
  "shellSha256": "fb3d6f01afb0d4d25e72f8d7946f7c26bca398ca13fc3b127b2cecc756d77a6d"
}
---
# AI Edit Guide — EuroYouth Estate Registration

Theme `system` · root `.mfp.mfp-realestate-registration.mfp-native-generated` · 18 fields · 1 steps (single).
...
- **C8 Change COLOUR (only if the user explicitly asks)**: `{op:"set_form_meta", themeCssOverrides:{"<scoped-var>":"#hex",…}, designDecision:"preserve"}`. ⚠ This template scopes its palette under TEMPLATE-SPECIFIC vars — target THOSE exact names (the generic `--primary`/`--accent` are INERT here). Available colour vars (current value):
  ...
  - `--rey-soft`: #fff3e0
  - `--rey-error`: #c0392b
  NEVER edit customCss for colour — customCss must stay byte-identical (sha256 `05e2702eb24a…`).
...
- customCss sha256 stays `05e2702eb24a489e…` · customHtml shell sha256 stays `fb3d6f01afb0d4d2…` (unless C2/C4 legitimately add a node).
