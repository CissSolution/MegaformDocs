  ...
  function initBehaviours(): void {
    ...
    if (wfTabLink) {
      wfTabLink.addEventListener('click', function () {
        ...
        // Re-init if: never inited, OR formId changed (e.g. new form just saved, got real ID)
        if (fid !== wfLastInitedFormId) {
          wfLastInitedFormId = fid;
