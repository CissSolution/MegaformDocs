...
- **C8 Change COLOUR (only if the user explicitly asks)**: \`{op:"set_form_meta", themeCssOverrides:{"--primary":"#hex","--accent":"#hex"}, designDecision:"preserve"}\`. NEVER edit customCss for colour — customCss must stay byte-identical (sha256 \`${f.hashes.customCssSha256.slice(0, 12)}…\`).
