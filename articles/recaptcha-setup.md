...
Both cases are covered under [What happens when the form is submitted](#what-happens-when-the-form-is-submitted).
...
layout space](../images/42-recaptcha-v3-form.png)
...
active](../images/43-recaptcha-v3-badge.png)
