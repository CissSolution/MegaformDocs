...
namespace MegaForm.DNN.Components
{
    public partial class FormView : PortalModuleBase, IActionable
    {
        ...
        private string ReadSharedPublicSetting(string key, string defaultValue = "")
        {
            var fullKey = "MegaForm_" + key;
            try
            {
            ...
            {
                // Fall through to the legacy portal-scoped value.
            }

            return ReadPortalSetting(key, defaultValue);
        }
        ...
        private void RegisterClientBootstrapFlags()
        {
            try
            {
                ...
                var aiEnabled = MegaForm.Core.Services.AiAssistant.AiFeatureGate.IsAvailable(
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            const string ADMIN_V = "?v=20260809-B421";
                ...
                if (ViewModel.ShowConfigPanel)
                {
                    ...
                    ClientResourceManager.RegisterStyleSheet(Page, ASSETS + "css/megaform-builder-shell.css" + BUILDER_V, 200);
                    ClientResourceManager.RegisterStyleSheet(Page, ASSETS + "css/megaform-builder.css" + BUILDER_V, 201);
                    ClientResourceManager.RegisterStyleSheet(Page, ASSETS + "css/megaform-builder-ts.css" + BUILDER_V, 202);
                    ...
                    RegisterPluginScripts(110, PLUGIN_V);
                    ...
                    ClientResourceManager.RegisterScript(Page, ASSETS + "js/bundles/megaform-builder.js" + BUILDER_V, 140);
                    ...
                    if (MegaForm.Core.Services.AiAssistant.AiFeatureGate.IsAvailable(
                ...
                else
                {
                    ...
                    RegisterPluginScripts(ViewModel != null ? ViewModel.PluginScripts : null, 105, PLUGIN_V);
                    ...
                    {
                        ClientResourceManager.RegisterStyleSheet(Page, ASSETS + "css/megaform-admin-shell.css" + ADMIN_V, 205);
                    ...
                    {
                        ClientResourceManager.RegisterStyleSheet(Page, ASSETS + "css/megaform-admin-shell.css" + ADMIN_V, 205);
                        ClientResourceManager.RegisterStyleSheet(Page, ASSETS + "css/megaform-builder-shell.css" + BUILDER_V, 206);
                        ClientResourceManager.RegisterStyleSheet(Page, ASSETS + "css/megaform-builder.css" + BUILDER_V, 207);
                        ClientResourceManager.RegisterStyleSheet(Page, ASSETS + "css/megaform-builder-ts.css" + BUILDER_V, 208);
                        ...
                        ClientResourceManager.RegisterScript(Page, ASSETS + "js/megaform-dashboard.js" + DASHBOARD_V, 118);
        ...
        private FormRenderViewModel BuildRenderViewModel()
        {
            ...
            vm.CaptchaBadgeVersion = "CaptchaVerify v20260814-01";
            vm.ReCaptchaSiteKey = ReadSharedPublicSetting("Captcha_ReCaptcha_SiteKey");
            vm.HCaptchaSiteKey = ReadSharedPublicSetting("Captcha_HCaptcha_SiteKey");
