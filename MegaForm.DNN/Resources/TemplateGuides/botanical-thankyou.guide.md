---
{
  ...
  "customCssSha256": "4c59bffdfdbe7eb1ec9d1ab4e79a32b312ccc80d015af56b15973512f061c60f",
  "shellSha256": "2d55ad399583b83e1a8ac9e83f00b4cfa3ffb4f52bfea57d3317d4ee8206954b"
}
---
# AI Edit Guide — Botanical Thank You Application

Theme `system` · root `.mfp.mfp-botanical-thankyou.mfp-native-generated` · 18 fields · 1 steps (single).
...
- **C8 Change COLOUR (only if the user explicitly asks)**: `{op:"set_form_meta", themeCssOverrides:{"<scoped-var>":"#hex",…}, designDecision:"preserve"}`. ⚠ This template scopes its palette under TEMPLATE-SPECIFIC vars — target THOSE exact names (the generic `--primary`/`--accent` are INERT here). Available colour vars (current value):
  ...
  - `--bot-soft`: #edf1df
  - `--bot-error`: #c0392b
  NEVER edit customCss for colour — customCss must stay byte-identical (sha256 `4c59bffdfdbe…`).
...
- customCss sha256 stays `4c59bffdfdbe7eb1…` · customHtml shell sha256 stays `2d55ad399583b83e…` (unless C2/C4 legitimately add a node).
