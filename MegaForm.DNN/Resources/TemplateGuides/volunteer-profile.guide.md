# Volunteer Profile - MegaForm AI Design Contract

Source mock route: /forms/volunteer-profile
Template slug: volunteer-profile
...
- Any AI edit must leave `settings.templateGuideSlug` pointing to `tpl-volunteer-profile`.
