---
{
  ...
  "customCssSha256": "c0278f52da25ba3a1a22fc1fb6bcc82754526d66f25521df388e494484f0f314",
  "shellSha256": "efd54bc82be0cda06b01a441e122b41f151c441692f8ba173b49a9582bf966fb"
}
---
# AI Edit Guide — Contact Us - Map Left, Corporate
...
- **C8 Change COLOUR (only if the user explicitly asks)**: `{op:"set_form_meta", themeCssOverrides:{"<scoped-var>":"#hex",…}, designDecision:"preserve"}`. ⚠ This template scopes its palette under TEMPLATE-SPECIFIC vars — target THOSE exact names (the generic `--primary`/`--accent` are INERT here). Available colour vars (current value):
  ...
  NEVER edit customCss for colour — customCss must stay byte-identical (sha256 `c0278f52da25…`).
...
- customCss sha256 stays `c0278f52da25ba3a…` · customHtml shell sha256 stays `efd54bc82be0cda0…` (unless C2/C4 legitimately add a node).
