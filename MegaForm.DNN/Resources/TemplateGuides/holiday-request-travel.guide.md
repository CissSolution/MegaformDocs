---
{
  "templateGuideSlug": "tpl-holiday-request-travel",
  "slug": "holiday-request-travel",
  "theme": "holiday-request-premium",
  "rootSelector": ".mfp.mfp-hol.mfp-native-generated",
  "tokenStyle": "double",
  ...
  "shellTexts": [
    ...
    "Accommodation",
    "Interests",
    "Pick what excites you (optional)",
    "Motivation",
  ...
  "customCssSha256": "9b55f8f7cb922770c5f30b25b791169121f5ab48530f3aefb22b57b56b188fa2",
  "shellSha256": "f09e19fe1d04ad067814162cecdb155e2da912dfd6cc8907c1779f7bc6f45d17"
}
---
# AI Edit Guide — Holiday Request Form

Theme `holiday-request-premium` · root `.mfp.mfp-hol.mfp-native-generated` · 17 fields · 1 steps (single).
...
| destination | Select | choice | - | 13 |
| duration | Select | choice | - | 7 |
| travel_type | Radio | cards | - | 3 |
| programme | Radio | cards | - | 3 |
| start_month | Select | choice | - | 12 |
| accommodation | Select | choice | - | 3 |
...
- **C7 Edit CARD options** (fields: travel_type, programme): `{op:"set_field_property", key:"travel_type", path:"options", value:[{"value":"v1","label":"Title","meta":"Subtitle","description":"…"},…], designDecision:"preserve"}`. Keep `optionDisplay:"cards"`. Card chrome (`.mf-option-group--cards`) stays. ⚠ ICONS — do NOT invent, change, or remove icons: MegaForm's rich-choice catalog/theme owns icon assignment. If an option ALREADY has an `icon`, keep it byte-for-byte; if it has none, OMIT the `icon` field (never emit a plain descriptive word like "city"/"beach" — it renders as literal text). Edit ONLY `label`/`meta`/`description`/`value`.
...
- **C8 Change COLOUR (only if the user explicitly asks)**: `{op:"set_form_meta", themeCssOverrides:{"<scoped-var>":"#hex",…}, designDecision:"preserve"}`. ⚠ This template scopes its palette under TEMPLATE-SPECIFIC vars — target THOSE exact names (the generic `--primary`/`--accent` are INERT here). Available colour vars (current value):
  ...
  NEVER edit customCss for colour — customCss must stay byte-identical (sha256 `9b55f8f7cb92…`).
...
- customCss sha256 stays `9b55f8f7cb922770…` · customHtml shell sha256 stays `f09e19fe1d04ad06…` (unless C2/C4 legitimately add a node).
- `settings.theme` stays `holiday-request-premium`. Every field keeps a `{{field:key}}` (own or via Row). Zero orphan/zero floating-outside-card fields.
