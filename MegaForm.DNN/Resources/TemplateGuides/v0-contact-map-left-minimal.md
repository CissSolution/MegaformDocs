---
{
  "templateGuideSlug": "tpl-v0-contact-map-left-minimal",
  "templateRef": "v0-contact-map-left-minimal",
  "title": "Contact Us - Map Left, Minimal",
  "description": "Premium contact page with Google Map on the left, form body on the right. Minimal color presets.",
  "sourceFile": "v0-contact-map-left-minimal.json",
  "designContract": {
    "layoutSummary": "Premium contact page with Google Map on the left, form body on the right. Minimal color presets.",
    "rootSelector": ".mf-contact-split",
    "panels": [
      {
        "name": "mf-map-wrap",
        "selector": ".mf-contact-split .mf-map-wrap",
        "fields": [],
        "tokens": [
          "map_embed_url"
        ],
      ...
      },
      {
        ...
        "selector": ".mf-contact-split .mf-contact-info",
        "fields": [],
        "tokens": [
          "contact_address",
          "contact_phone",
      ...
      {
        "name": "mf-header",
        "selector": ".mf-contact-split .mf-header",
        "fields": [],
        "tokens": [
          "brand_title",
          "brand_subtitle"
      ...
      {
        "name": "mf-submit-wrap",
        "selector": ".mf-contact-split .mf-submit-wrap",
        "fields": [],
        "tokens": [
          "submit_btn_text"
        ],
      ...
      {
        "name": "mf-footer",
        "selector": ".mf-contact-split .mf-footer",
        "fields": [],
        "tokens": [
          "footer_message"
        ],
  ...
  "theme": {
    ...
    "cssNamespace": ".mf-contact-split",
    "lockedCss": true,
    "presetPolicy": "Uses themeSelector with presetSet='contact-split-themes', defaultThemeKey='clean-white'. Preset colors flow through standard tokens."
  },
  ...
  "conversionExamples": [
    {
      "from": "Contact Us - Map Left, Minimal",
      "to": "Contact Us - Map Left, Minimal — localized/shortened version",
      "allowedChanges": [
        "title",
        "description",
        "field labels",
...
# AI Refine Guide — Contact Us - Map Left, Minimal

## Design Overview
Premium contact page with Google Map on the left, form body on the right. Minimal color presets.

## Layout Panels
- **mf-map-wrap** (`.mf-contact-split .mf-map-wrap`): Template region
  - Content tokens: map_embed_url
- **mf-contact-info** (`.mf-contact-split .mf-contact-info`): Template region
  - Content tokens: contact_address, contact_phone, contact_email
- **mf-header** (`.mf-contact-split .mf-header`): Template region
  - Content tokens: brand_title, brand_subtitle
- **mf-form-col** (`.mf-contact-split .mf-form-col`): Template region
  - Fields: full_name, email, phone, company, subject, message, preferred_contact, newsletter
  - Content tokens: section_label
- **mf-submit-wrap** (`.mf-contact-split .mf-submit-wrap`): Template region
  - Content tokens: submit_btn_text
- **mf-footer** (`.mf-contact-split .mf-footer`): Template region
