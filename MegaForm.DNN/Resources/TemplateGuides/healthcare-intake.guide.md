# Wellness Intake - MegaForm AI Design Contract

Source mock route: /forms/healthcare-intake
Template slug: healthcare-intake
...
- Any AI edit must leave `settings.templateGuideSlug` pointing to `tpl-healthcare-intake`.
