---
{
  ...
  "templateRef": "v0-contact-map-right-modern",
  "title": "Contact Us - Map Right, Modern",
  "description": "Premium contact page with Google Map on the right, form body on the left. Modern color presets.",
  "sourceFile": "v0-contact-map-right-modern.json",
  "designContract": {
    "layoutSummary": "Premium contact page with Google Map on the right, form body on the left. Modern color presets.",
  ...
  "theme": {
    ...
    "lockedCss": true,
    "presetPolicy": "Uses themeSelector with presetSet='contact-split-themes', defaultThemeKey='startup-indigo'. Preset colors flow through standard tokens."
  },
  ...
  "conversionExamples": [
    {
      "from": "Contact Us - Map Right, Modern",
      "to": "Contact Us - Map Right, Modern — localized/shortened version",
      "allowedChanges": [
        "title",
        "description",
        "field labels",
...
# AI Refine Guide — Contact Us - Map Right, Modern

## Design Overview
Premium contact page with Google Map on the right, form body on the left. Modern color presets.
