...
{
    /// <summary>
    /// Shared template normalization logic used by the Umbraco builder catalog.
    /// </summary>
    public static class UmbracoBuilderTemplateNormalizer
    {
        public static UmbracoBuilderTemplateCatalogService.BuilderTemplateRecord Normalize(string json, string fileName, string relativePath)
        {
            ...
            return new UmbracoBuilderTemplateCatalogService.BuilderTemplateRecord
            {
        ...
        public static string BuildPersistedJson(UmbracoBuilderTemplateCatalogService.BuilderTemplateRecord record)
        {
            var obj = new JObject
            {
                ["version"] = "1.0",
