...
{
    /// <summary>
    /// Umbraco implementation of IModuleSettingsService using the shared MF_ModuleSettings table.
    /// </summary>
    public class UmbracoModuleSettingsService : IModuleSettingsService
    {
        private readonly MegaFormDbContext _db;
        public UmbracoModuleSettingsService(MegaFormDbContext db) { _db = db; }
