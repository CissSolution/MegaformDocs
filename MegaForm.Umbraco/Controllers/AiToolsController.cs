...
namespace MegaForm.Umbraco.Controllers
{
    ...
    public class AiToolsController : ControllerBase
    {
        ...
        public AiToolsController(IAiKnowledgeService svc, IConnectionRegistry connectionRegistry, IFormRepository formRepo, IPlatformContext platform, IWebHostEnvironment env, Microsoft.Extensions.Configuration.IConfiguration config, IModuleSettingsService moduleSettings)
        {
            _svc = svc;
        ...
        public IActionResult SqlTables(string search = null, int top = 200, string connectionKey = null)
        {
            ...
            catch (Exception) { return StatusCode(500, new { error = "could not list tables — check the connection in Settings and the server log" }); }
        }
