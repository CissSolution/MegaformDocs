...
{
    /// <summary>
    /// MegaForm AI Assistant configuration API for Umbraco.
    /// Mirrors MegaForm.Web.Controllers.AiAssistantController.
    /// </summary>
    ...
    public class AiAssistantController : ControllerBase
    {
        ...
        private bool IsAdmin => User?.Identity?.IsAuthenticated == true && (User.IsInRole("Administrator") || User.IsInRole("admin") || User.IsInRole("Administrators"));
