...
{
    /// <summary>
    /// [UmbracoStarters v20260710] Business Starter setup/launch endpoints for Umbraco.
    /// Mirrors MegaForm.Web.Controllers.StarterController.
    /// </summary>
    [ApiController]
    ...
    public class StarterController : ControllerBase
    {
        ...
        private UserContext GetCurrentUserContext()
        {
            ...
            {
                UserId = _ctx.UserId > 0 ? _ctx.UserId : ParseUserId(user),
